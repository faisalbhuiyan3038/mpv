...
/* --- tooBright (dx9) --- */
/* v1.41 (2023-07) released by butterw under GPLv3
...
out = f(x, M: Multiply)= (1-M)*x + M*x*x = M*x^2 -M*x +x
...
>> Positive: (Multiply Blend) decreases brightness. Increases contrast in highlights. ex: 0.20
    - Brightness decrease is maximum at the midpoint (-M/4).
    - Contrast = 1-M +2M*x
    Contrast increases linearly with input level and is maximum at the White point (1+M).
